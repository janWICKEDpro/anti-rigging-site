                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: TextField(
                                onChanged: (value) {
                                 BlocProvider.of<AdminDashboardBloc>(context).add(OnRoleNameChanged(index,roleName: value));
                                },
                              ...
                              children: [
                                Expanded(
                                  child: TextField(
                                    onChanged: (value) {
                                      ...
                                      // });
                                      BlocProvider.of<AdminDashboardBloc>(context).add(OnCandidateNameChanged(candidateName: value));
                                    },
                                    decoration: InputDecoration(
                                      labelText: 'Sub Field ${subIndex + 1}',
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    // });
            BlocProvider.of<AdminDashboardBloc>(context).add(OnCandidateFieldsRemoved(index, subIndex));
                                  },
                                ),
                              ],
                            ),
