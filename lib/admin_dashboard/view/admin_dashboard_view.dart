...
class AdminDashboad extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AdminDashboardBloc(BlocProvider.of<UserSessionBloc>(context))..add(OnElectionFetchedEvent()),
            ...
            return BlocListener<UserSessionBloc, UserSessionState>(
              listener: (context, state) {
                if (state is SessionDeleted) {
                  context.read<AdminDashboardBloc>().add(OnSignOutButtonClicked());
                }
              },
              child: Scaffold(
